...
//   else if(userRoles === 'Admin WA')
//     pdfUrl = process.env.REACT_APP_WA_BACKEND_API_URL + '/manual_book/MANUAL_BOOK_ADMIN_WA.pdf'; // Ganti dengan URL PDF dari backend
...
export default function ManualBookPage() {
  ...
  const pdfUrl = fileName
    ? `${process.env.REACT_APP_WA_BACKEND_API_URL}/manual_book/${encodeURIComponent(fileName)}`
    : "";
