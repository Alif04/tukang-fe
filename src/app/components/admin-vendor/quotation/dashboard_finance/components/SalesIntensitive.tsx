...
const SalesIntensitive: React.FC<Props> = ({className, chartHeight}) => {
      ...
      <div className='card-body p-2 d-flex justify-content-center'>
        <div className='d-flex align-items-center'>
          ...
          <div className='d-flex flex-column gap-4'>
            <div className='fs-5 text-dark text-muted text-center'>Sales Insentive</div>
            <div className='fs-1 d-block m-auto'>60</div>
            <div className='fs-5 text-muted text-center'>Insentive bulan ini</div>
          </div>
        </div>
      </div>
    </div>
