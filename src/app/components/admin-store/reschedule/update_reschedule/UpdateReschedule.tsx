            ...
            {(() => {
              if (rescheduleDetail?.order?.payment_type === 'survey') {
                if (rescheduleDetail?.order?.work_orders === null) {
                  ...
                  rescheduleDetail?.order?.payment_type === 'survey' &&
                  rescheduleDetail?.order?.work_orders?.work_order_status[0]?.work_order_items
                    ?.length >= 1 &&
                  rescheduleDetail?.order?.quotation?.length === 0
                ) {
                  return (
                    <div className='table-warranty-content'>
                      <Table hover responsive='md'>
                  ...
                  rescheduleDetail?.order?.quotation?.length >= 1 &&
                  rescheduleDetail?.order?.payment_type === 'survey'
                ) {
                  return (
                    <div className='table-warranty-content'>
