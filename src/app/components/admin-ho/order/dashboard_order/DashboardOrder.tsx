  ...
  return (
    <section id='dashboard-order'>
      ...
      <div className='row g-5 g-xl-8'>
        ...
        <div className='col-xl-4'>
          <ChartDonut2 className='card-xl-stretch mb-xl-8' chartHeight='300px' />
        </div>
        <div className='col-xl-4'>
          <TableList className='card-xl-stretch mb-xl-8' />
        </div>
      </div>
      {/* end::Row */}
    </section>
