...
const chartOptions = (chartHeight: string): ApexOptions => {
  ...
  const multiOrder = getCSSVariableValue('--kt-info')
  ...
  return {
    ...
    labels: ['NEW', '0 0RDER', '1 ORDER', 'MULTI ORDER'],
    legend: {
      show: true,
      height: 20,
      position: 'left',
    ...
    colors: [pendingColor, processColor, cancelColor, multiOrder],
    grid: {
      padding: {
        top: 10,
      },
